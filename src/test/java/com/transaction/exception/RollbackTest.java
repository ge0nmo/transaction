...
public class RollbackTest
{
    ...
    @Test
    void checkedRuntimeException()
    {
        assertThatThrownBy(() ->  rollbackService.checkedRuntimeException())
    ...
    static class RollbackService
    {
        ...
        @Transactional
        public void checkedRuntimeException()
        {
            log.info("call checkedMyRuntimeException");
